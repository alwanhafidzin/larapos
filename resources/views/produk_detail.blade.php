	...
	<section class="bg-color-0">
		<div class="container">
			<div class="row align-items-center half-screen space">
				<div class="col-md-12">
					<h4><a href="{{url('/produk')}}" class="btn btn-danger">Back</a> Detail Produk</h4>
					<br>
					<hr>
				</div>
				<div class="container">
					<div class="row">
                        <div class="col-md-12"><img src="{{url($produk->foto)}}" height="300"></div>
						<div class="col-md-12 mt-3">
                            <h4>Deskripsi</h4><hr><p class="m-0">{{$produk->deskripsi}}</p>
						</div>
					</div>
				</div>
			</div>
